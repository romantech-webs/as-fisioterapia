  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="as-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="AS FISIOTERAPIA"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="as-fisioterapia"
